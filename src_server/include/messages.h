...
*/
	...
	#define REPL_004 ("004 epirc 1.0 +m 0")
	...
	#define REPL_211 ("211 <linkname> <sendq> <sent messages> \
	...
	#define REPL_401 ("401 %s :No such nick/channel")
	#define REPL_402 ("402 <server name> :No such server")
	#define REPL_403 ("403 %s :No such channel")
	#define REPL_404 ("404 %s :Cannot send to channel")
